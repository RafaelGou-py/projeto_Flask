...
def conectar_cloudBD():
    con = psycopg2.connect(
        host= 'dpg-cnsdccmn7f5s73damot0-a.oregon-postgres.render.com',
        database= 'projetocloudcomp',
        user= 'projetocloudcomp_user',
        password= 'kIPBqxhBDN53UQrV9Ik0mR0Y40Wa56z4'
    )
    return con
